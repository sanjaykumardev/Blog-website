    ...
    <div className=" flex items-center justify-center h-[80vh] w-full rounded z-index ">
        <div className="flex items-center justify-center flex-col space-y-4 md:w-90 w-80  " >
            <h1 className='md:text-lg textlg font-bold'>Create An Account</h1>
              <input 
              onChange={(e)=>setUserName(e.target.value)}  className="border-2 border-black p-3 md:w-full w-full rounded-lg z-index-2 "  
              type="text" 
              placeholder='Enter Your UserName'
              />

                <input 
                onChange={(e)=>setEmail(e.target.value)}   className="border-2 border-black p-3 md:w-full w-full rounded-lg "  
                type="text"
                 placeholder='Enter Your Email'
                 />

                <input 
                onChange={(e)=>setPassword(e.target.value)}  className="border-2 border-black p-3 md:w-full w-full rounded-lg "  
                type="password"
                placeholder='Enter Your Password'
                />

                <button onClick={handelDetails} className="md:w-80% p-3 w-80 bg-black text-white rounded-full  shadow-lg  font-bold ">Register</button>
