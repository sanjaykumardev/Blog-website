  ...
  return (
    <> 
                    ...
                    <div className="flex items-center justify-between px-4 md:px-[200px] py-4  pz-5 flex-shrink bg-black  ">
                         ...
                         <input 
                          onChange={(e)=>setEmail(e.target.value)} className="p-2 w-80 mb-20 border-2 border-black rounded-lg " 
                          type="text"
                          placeholder='Enter your email' 
                          />

                         <input  
                         onChange={(e)=>setPassword(e.target.value)}  className="p-2 w-80  border-2 border-black rounded-lg "
                          type="password" 
