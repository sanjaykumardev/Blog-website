...
const CreatePost = () => {
  ...
  //  too much re-rendering want to check  youtube time: 1:12:20 \\
    ...
    <>
      ...
      <div className="px-6 md:px-[200px] mt-8">
        ...
        <div className='flex md:justify-center  mt-7 '>
          <button className='bg-black  mx-3 md:w-[20%] w-[50%] text-white  font-semibold px-4 py-2 md:text-xl text-lg '>Create </button>
