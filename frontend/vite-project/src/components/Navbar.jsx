  ...
  return (
    <>
      <div className=" sticky  md:sticky md:top-0 bg-black flex items-center justify-between  md:px-[200px] py-4   border-bottom-2  md:w-[full]">
        ...
        { user ? <button className='mr-2'><Link to='/write'>Write</Link></button> : <button className='px-5 py-2 cursor-pointer rounded-lg font-semibold xl:text-1xl text-black bg-white'><Link to="/Login">Login</Link></button>}
        ...
        <div  onClick= {showMenu} className='md:hidden text-lg w-[50px] '>
